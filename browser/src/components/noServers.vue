<template>
   <div class="container" @click="headerHide">
     <!--头部搜索和多语言选择-->
     <headerVue v-on:childByValue="childByValue" v-on:childByValue2="childByValue2" ref="headerClick" v-on:loginShowNow="loginShowNow" v-on:outClick="outClick" @click.stop></headerVue>
     <div class="noPage" :style="{minHeight:minHeight + 'px'}">
       <img src="./../assets/500.png" alt="" :style="{marginTop:minHeight/2-172 + 'px'}">
       <span class="text">服务器开小差了，稍后再试吧</span>
       <p class="btnBox">
