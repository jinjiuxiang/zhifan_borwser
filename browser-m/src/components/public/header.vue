<template>
    <div class="container">
      <div class="header" v-show="searchHide">
        <img @click.stop @click="getBack" src="./../../assets/logom.svg" alt="">
        <p class="show">
          <img src="./../../assets/searchm.svg" @click="searchShow" alt="">
          <span class="langSel" @click.stop @click="langShow">{{langLabel}}&nbsp;<img src="./../../assets/down1.svg" alt="">&nbsp;
      ...
      <!---->
      <div class="header2" v-show="!searchHide">
        <span class="coin" @click.stop @click="showClick">{{selectName | nameChange}}&nbsp;&nbsp;<img src="./../../assets/down1.svg" alt="">
        ...
        <input class="text" :placeholder="$t('text.placeHolder')" type="text" v-model="key" @focus='focusOn' @keyup.enter="getSearch">
        <span class="nBtn">
          <li class="cancel" @click="cancelClick" v-show="key != ''"><img src="./../../assets/cancelm.svg" alt=""></li>
          <li class="space" v-show="fShow"></li>
          <li class="qx" @click="getSearch" v-show="fShow">搜索</li>
        </span>
      </div>
    </div>
</template>
