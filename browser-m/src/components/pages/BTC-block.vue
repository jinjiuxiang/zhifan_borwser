<template>
 <div class="container">
    <!--title-->
   <div class="title">
     <span class="titleCoin"><img :src="changeImage(message.coinType)" alt=""> {{message.coinType | coinChange}} {{$t('text.block')}}：</span>
   ...
   <div class="desc">
     ...
     <p class="descMin">
       <span class="descLabel">{{$t('text.blockReward')}}</span>
       <span class="descText">{{message.reward}}&nbsp;{{message.coinType | coinChange}}</span>
     </p>
     <p class="descMin">
     ...
     <p class="descMin">
       <span class="descLabel">{{$t('text.blockSize')}}</span>
       <span class="descText">{{message.pBlockVo.size | sizeChange}}&nbsp;KB</span>
     </p>
     <p class="descMin">
     ...
     <p class="descMin">
       <span class="descLabel">{{$t('text.blockHash')}}</span>
       <span class="descText erHash">{{message.pBlockVo.merkleRoot}}</span>
     </p>
   </div>
   <!--txn-->
   <div class="txn">
     ...
     <div class="txnMin" v-show="message.txnInfoVoList.length >0" v-for="site in message.txnInfoVoList">
       ...
       <p class="txnBody">
         <span class="txnLabel">{{$t('text.totalInput')}}（{{message.coinType | coinChange}}）</span>
         <span class="txnText input">{{site.inputTotal}}</span>
       </p>
       <p class="txnBody">
         <span class="txnLabel">{{$t('text.totalOutput')}}（{{message.coinType | coinChange}}）</span>
         <span class="txnText outPut">{{site.outputTotal}}</span>
       </p>
       <p class="txnBody">
         <span class="txnLabel">{{$t('text.txnFee')}}（{{message.coinType | coinChange}}）</span>
         <span class="txnText">{{site.fee}}</span>
       </p>
       <p class="txnBody">
         <span class="txnLabel">{{$t('text.inputNum')}}</span>
         <span class="txnText">{{site.inputs | getLength}}</span>
       </p>
       <p class="txnBody">
         <span class="txnLabel">{{$t('text.outputNum')}}</span>
         <span class="txnText">{{site.outputs | getLength}}</span>
       </p>
     </div>
